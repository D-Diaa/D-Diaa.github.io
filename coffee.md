...
<div class="coffee-page">
  <div class="coffee-header">
    ...
    <h1 class="page-title">Coffee Brewing Guide</h1>
  </div>
  ...
  <div class="recipe-card">
    <div class="recipe-header">
      ...
      <div class="recipe-description">
        <p>A hybrid brewing method combining the best of percolation and immersion for a balanced, flavorful cup.</p>
      </div>
    </div>
    
    <div class="recipe-metrics">
      <div class="metric-item">
        <div class="metric-icon cherry-icon">
      ...
      <div class="metric-item">
        <div class="metric-icon grind-icon">
    ...
    <div class="brew-timeline">
      <h3 class="timeline-title">Brewing Timeline</h3>
    ...
    <div class="recipe-steps">
      ...
      <ul class="steps-list">
        ...
        <li class="step-item preparation">
          ...
          <div class="step-content">
            <div class="step-header">
              <strong>Pre-wet the filter</strong>
            </div>
            <p>Rinse the filter with hot water to remove any paper taste and preheat the dripper.</p>
          </div>
        </li>
        <li class="step-item preparation">
          <span class="time-badge prep-time">Prep</span>
    ...
    <div class="recipe-steps">
      ...
      <ul class="steps-list">
        ...
        <li class="step-item percolation">
          ...
          <div class="step-content">
            <div class="step-header">
              <strong>Percolation</strong>
            </div>
            <p>At 1:00, pour 100g of water in a spiral motion, aiming for a 40-second pour. This can be a bit faster if you want to increase the agitation. Selectively pour on darker, drier spots to ensure even saturation.</p>
            <div class="duration-indicator">
              <div class="duration-bar">
        ...
        <li class="step-item immersion">
          ...
          <div class="step-content">
            <div class="step-header">
              <strong>Close the switch</strong>
            </div>
            <p>At 2:00, close the switch to start the immersion phase.</p>
          </div>
        </li>
        <li class="step-item immersion">
          <span class="time-badge">2:00</span>
        ...
        <li class="step-item serving">
          ...
          <div class="step-content">
            ...
            <p>Swirl, smell, slurp, and enjoy your coffee!</p>
          </div>
        </li>
      </ul>
    </div>
    ...
    <div class="recipe-footer">
      ...
      <div class="recipe-print">
        <span class="print-label">Print this recipe:</span>
        <div class="print-button">
          <a href="javascript:window.print()" class="print-icon" aria-label="Print this recipe">
